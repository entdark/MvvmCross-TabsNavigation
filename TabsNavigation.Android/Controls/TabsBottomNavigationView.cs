...
using AndroidX.CustomView.View;
using Java.Interop;
using MvvmCross.Exceptions;

namespace TabsNavigation.Android.Controls;

[Register("TabsNavigation.Android.Controls.BottomNavigationView")]
public class TabsBottomNavigationView : Google.Android.Material.BottomNavigation.BottomNavigationView
{
    ...
    {
        Menu.FindItem(ev.Position)?.SetChecked(true);
    }
    ...
    protected override void OnRestoreInstanceState(IParcelable state)
    {
        ...
        var parcelable = bundle != null ? (BundleCompat.GetParcelable(bundle, bundleSavedState, Java.Lang.Class.FromType(typeof(IParcelable))) as IParcelable) : state;
