...
namespace TabsNavigation.Android.Controls;

[Register("TabsNavigation.Android.Controls.ViewPager")]
public class TabsViewPager : AndroidX.ViewPager.Widget.ViewPager
{
    ...
    {
        private const string bundleFragmentsInfoKey = "TabStatePagerAdapter_FragmentsInfo";
        ...
        public TabsAdapter(Context context, FragmentManager fragmentManager, List<MvxViewPagerFragmentInfo> fragmentsInfo, int tabsCount) : base(context, fragmentManager, fragmentsInfo)
        {
        ...
        {
            //update only when all the infos got added
        ...
        public override Fragment GetItem(int position, Fragment.SavedState fragmentSavedState = null)
        {
            ...
            if (FragmentsInfo?.Count > position && fragment is IMvxFragmentView { ViewModel : { } } mvxFragment)
            {
